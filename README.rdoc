...
{<img src="https://github.com/tckz/redmine_wiki_preview_ext/raw/master/ss.png" />}[http://passing.breeze.cc/mt/]
...
Source code:
git://github.com/tckz/redmine_wiki_preview_ext.git
...
4. Setup wiki preview extension plugin settings in the Plugin settings panel.
    'Duration' : Specify seconds to auto preview duration.
    If this value is 0, auto preview feature is disabled.
